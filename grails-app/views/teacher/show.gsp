	...
	<body>
		...
		<div id="show-teacher" class="content scaffold-show" role="main">
			...
			<ol class="property-list teacher">
				...
				<g:if test="${teacherInstance?.code}">
				<li class="fieldcontain">
					<span id="code-label" class="property-label"><g:message code="teacher.code.label" default="Code" /></span>
					
						<span class="property-value" aria-labelledby="code-label"><g:fieldValue bean="${teacherInstance}" field="code"/></span>
