                        ...
                        <table>
                            <thead>
                                <tr>
                                        ...
                                        <g:sortableColumn property="code" title="${message(code: 'teacher.code.label', default: 'Code')}" />
                            ...
                            <tbody>
                                <g:each in="${teacherInstanceList}" status="i" var="teacherInstance">
                                    <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                        ...
                                        <td><g:link action="show" id="${teacherInstance.id}">${fieldValue(bean: teacherInstance, field: "code")}</g:link></td>
