                        ...
                        <table>
                            <thead>
                                <tr>
                                        ...
                                        <g:sortableColumn property="name" title="${message(code: 'grade.name.label', default: 'Name')}" />
                            ...
                            <tbody>
                                <g:each in="${gradeInstanceList}" status="i" var="gradeInstance">
                                    <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                        ...
                                        <td><g:link action="show" id="${gradeInstance.id}">${fieldValue(bean: gradeInstance, field: "name")}</g:link></td>
