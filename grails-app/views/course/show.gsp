	...
	<body>
		...
		<div id="show-course" class="content scaffold-show" role="main">
			...
			<ol class="property-list course">
				...
				<g:if test="${courseInstance?.knowledgePoint}">
				<li class="fieldcontain">
					<span id="knowledgePoint-label" class="property-label"><g:message code="course.knowledgePoint.label" default="Knowledge Point" /></span>
					
						<g:each in="${courseInstance.knowledgePoint}" var="k">
						<span class="property-value" aria-labelledby="knowledgePoint-label"><g:link controller="knowledgePoint" action="show" id="${k.id}">${k?.encodeAsHTML()}</g:link></span>
						</g:each>
